...
int main(int argc, char** argv)
{
	...
	if (pcl::io::loadPCDFile("r.pcd", *cloud) == -1)
	{
		cout << "点云数据读取失败！" << endl;
	}
	...
	//downSampled.setLeafSize(0.5f, 0.5f, 0.5f);  //设置滤波时创建的体素体积为1cm的立方体
	...
	//statisOutlierRemoval.setStddevMulThresh(5.0);                     //设置判断是否为离群点的阀值:均值+1.0*标准差
	...
	normalEstimation.setKSearch(16);// 使用当前点周围最近的10个点
